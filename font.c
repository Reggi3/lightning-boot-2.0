/* Font.c -- Bitmap font for OpenDidj Lightning-boot
 *
 * Copyright status unknown
 *
 * This font bitmap was originally taken from a driver claiming to be
 * for the Nokia 6100. The contents of this file may have come from
 * Nokia, but the exact source is unknown. Are you the owner of this
 * code? Am I using it in a way that you do not approve? If so,
 * contact me and I'll make it right. Until then, assuming this is
 * GPLv2-friendly code.
 *
